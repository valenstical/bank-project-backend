...
//   'Adewunmi (I desire the crown)',
//   "Adeyemi (I'm worth of the crown)",
//   'Adisa (one who is clear)',
//   'Afolabi (born into wealth)',
//   'Afolabi (born with wealth)',
//   'Akande (first born)',
//   'Akanni (the first one)',
//   'Akintoye (strength is enough)',
//   'Amadi (destined to die at birth)',
//   'Anituke (taken care of from conception)',
//   "Anuoluwaop (Abundance of God's mercies)",
//   "Anuoluwaposi (Increase of God's mercies)",
//   'Ayo (joy)',
//   'Ayodele (joy has come home)',
//   'Ayokunle (joy fills the home)',
//   'Ayokunumi (overwhelmed with wealth)',
//   'Ayomide (joy has arrived)',
//   'Ayoola (joy of wealth)',
//   "Ayotola (joy's enough wealth)",
//   'Ayotunde (joy returned)',
//   'Babajide (father has come to life again)',
//   'Babajide (father has returned)',
//   'Babatunde (father has returned)',
//   'Babatunde (father returned)',
//   'Bamidele (follow me home)',
//   'Bidemi (born awaiting me)',
//   'Boluwatife (will of God)',
//   'Dayo (joy arrives)',
...
//   'Enitan (person with a history)',
//   'Fiayosemi (mold me with joy)',
//   'Folami (respect and honor me)',
//   'Gbohunmi (God heard me cry)',
//   'Gbolahun (show the wealth)',
//   'Gboyega (carry the glory high)',
//   'Idowu (born after twins)',
//   'Ifedapo (love came together)',
//   'Ifedayo (love turned to joy)',
//   'Jibola (child who woke up with wealth)',
//   'Kayin (celebrated child)',
//   'Kayode (he brought joy)',
//   'Kolapo (wealth in abundance)',
//   'Kolawole (wealth has come)',
//   'Mayowa (brings joy)',
//   'Moniade (I have the crown)',
//   'Monisola (I obtained wealth)',
//   'Morounkola (someone to help gather wealth)',
//   'Numilekunoluwa (clean my tears Lord)',
//   'Olabode (wealth returns)',
//   'Oladele (wealth has reached home)',
//   'Olaitan (eternal wealth)',
//   'Olakunle (abundance of wealth at home)',
//   'Olamilekan (my wealth grew)',
//   'Olamilekan (wealth has increased)',
//   'Olanrewaju (wealth is the future)',
//   "Olanrewaju (wealth's moving forward)",
//   "Olaonipekun (wealth's endless)",
//   'Olarenrewaju (wealth in the future)',
//   'Olashalew (wealth chose a place to go)',
//   "Olasinbo (wealth's on the way)",
//   "Olatimbo (my wealth's on its way)",
//   'Olatunji (wealth woke up again)',
//   'Olawunmi (I desire wealth)',
//   "Olayemi (I'm worthy of wealth)",
//   'Olayinka (surrounded with wealth)',
//   'Ololade (wealthy one has come)',
//   'Olorunyomi (God saved me)',
//   'Olufemi (God loves me)',
//   'Olufunke (God has cared for)',
//   'Olufunmilayo (God gave me joy)',
//   'Olufunmilola (God gives me wealth)',
//   'Olugbenga (God raised me up)',
...
//   "Oluwakemi (God's taking care of me)",
//   'Oluwalanni (we have God)',
//   'Oluwamuyiwa (God brought this one)',
//   'Oluwarantimi (God remembered me)',
//   'Oluwaremilekun (God dried my tears)',
//   'Oluwasanmi (God rewarded me)',
//   'Oluwasegun (God has conquered)',
//   "Oluwasegun (God's victorious)",
//   'Oluwaseun (thank you Lord)',
//   'Oluwaseun (we thank God)',
//   'Oluwaseyi (God made this)',
//   'Oluwasola (God made wealth)',
//   'Oluwatobi (God is great)',
//   "Oluwatoke (God's to be adored)",
//   'Oluwatomiwa (God searched for me)',
//   "Oluwatoniyi (God's worthy of praise)",
//   "Oluwatope (God's to be praised)",
//   "Oluwatoyin (God's to be praised)",
//   'Oluwatunmise (God regenerated me)',
//   'Oluwayemisi (God honors me)',
//   "Oluwayemisi (I'm understanding God more)",
//   'Oluwole (God has entered)',
...
//   'Sunbola (slepts and had wealth)',
//   'Sunkanmi (draw close to me)',
//   'Tejumola (aims to gain wealth)',
//   'Teleayo (lay ground for joy)',
//   'Teleola (lay ground for wealth)',
//   'Temidare (mine turned good)',
//   'Temidayo (mine has turned to joy)',
//   'Temilade (mine is the crown)',
//   'Temiloluwa (God is mine)',
//   'Temitope (enough to give thanks)',
//   "Temitope (mine's worthy of praise)",
//   'Teniayo (foundation of joy)',
//   'Teniola (foundation of wealth)',
//   'Tiwalade (crown is ours)',
//   'Tokunbo (born in my absence)',
//   "Toluwalope (god's to be praised)",
//   'Yejide (mother has come back to life)',
...
//   'Adebimpe (crown is complete)',
//   'Adebisi (we added to the crown)',
//   'Adebola (the crown met wealth)',
//   'Adebowale (the crown came home)',
//   'Adeboye (crown has brought title)',
//   'Ademuyiwa (the crown brought this)',
//   'Adenika (crown needs to be pampered)',
...
//   "Anuoluwaposi (Increase of God's mercies)",
//   'Ayo (joy)',
//   'Ayodele (joy came home)',
//   'Ayokunle (joy filled the home)',
//   'Ayokunumi (overwhelmed with wealth)',
...
//   'Ekundayo (sorrow becomes joy)',
//   'Eniola (person of wealth)',
//   'Eniola (person with wealth)',
//   'Enitan (person of story)',
//   'Enitan (person with a history)',
//   'Fehintola (returned wealth)',
//   'Feyisayo (use as wealth)',
//   'Fiayosemi (mold me with joy)',
//   'Folake (take care with wealth)',
//   'Folami (respect and honor me)',
//   'Fowoke (pampered with wealth)',
//   'Gbemisola (God lifted me into wealth)',
...
//   'Mayowa (brings joy)',
//   'Modupe (I praise God)',
//   'Mojisola (I awoke into wealth)',
//   'Mojisola (wake up to wealth)',
//   'Moniade (I have the crown)',
//   "Monifa (I'm lucky)",
//   'Monisola (I obtained wealth)',
//   "Morenike (I've got one to pamper)",
//   'Morounkola (someone to help gather wealth)',
//   'Numilekunoluwa (clean my tears Lord)',
//   'Obafunke (the King gave me to take care of)',
//   'Olabimpe (wealth made me complete)',
//   'Oladele (wealth has reached home)',
//   'Olaitan (eternal wealth)',
//   'Olakunle (abundance of wealth at home)',
//   'Olamide (my wealth arrived)',
//   "Olasinbo (wealth's on the way)",
//   "Olatimbo (my wealth's on its way)",
//   'Olawunmi (I desire wealth)',
//   "Olayemi (I'm worthy of wealth)",
...
//   "Oluwakemi (God's taking care of me)",
//   'Oluwalanni (we have God)',
//   'Oluwamisimi (God breathed on me)',
//   'Oluwamuyiwa (God brought this one)',
//   'Oluwarantimi (God remembered me)',
//   'Oluwaremilekun (God dried my tears)',
//   'Oluwasanmi (God rewarded me)',
...
//   'Oyindamola (honey mixed with wealth)',
//   'Pamilekunayo (cause me tears of joy)',
//   'Rinsiouluwa (soaked in the Lord)',
//   'Shanumi (have mercy on me)',
//   'Similola (rest in wealth)',
//   'Similoluwa (rest in the Lord)',
